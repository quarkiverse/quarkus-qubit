package io.quarkus.qusaq.it.aggregation;
...
/**
 * Comprehensive test suite for ActiveRecord pattern aggregation operations.
...
class AggregationTest {
    ...
    void setupTestData() {
        ...
        // Standard products: Laptop (1299.99), Smartphone (899.99), Desk Chair (299.99),
        // Coffee Maker (89.99), Monitor (399.99)
    }
    ...
    @Test
    void minAge() {
        Integer minAge = Person.min((Person p) -> p.age).getSingleResult();
    ...
    @Test
    void maxAge() {
        Integer maxAge = Person.max((Person p) -> p.age).getSingleResult();
    ...
    @Test
    void avgAge() {
        Double avgAge = Person.avg((Person p) -> p.age).getSingleResult();
    ...
    @Test
    void sumIntegerAge() {
        Long sumAge = Person.sumInteger((Person p) -> p.age).getSingleResult();
    ...
    void sumLongEmployeeId() {
        Long sumEmployeeId = Person.sumLong((Person p) -> p.employeeId).getSingleResult();
    ...
    void sumDoubleSalary() {
        Double sumSalary = Person.sumDouble((Person p) -> p.salary).getSingleResult();
    ...
    void minAgeWithPredicate() {
        Integer minAge = Person.where((Person p) -> p.active).min((Person p) -> p.age).getSingleResult();
    ...
    void maxAgeWithPredicate() {
        Integer maxAge = Person.where((Person p) -> p.active).max((Person p) -> p.age).getSingleResult();
    ...
    void avgAgeWithPredicate() {
        Double avgAge = Person.where((Person p) -> p.active).avg((Person p) -> p.age).getSingleResult();
    ...
    void sumIntegerAgeWithPredicate() {
        Long sumAge = Person.where((Person p) -> p.active).sumInteger((Person p) -> p.age).getSingleResult();
    ...
    void sumLongEmployeeIdWithPredicate() {
        Long sumEmployeeId = Person.where((Person p) -> p.active).sumLong((Person p) -> p.employeeId).getSingleResult();
    ...
    void sumDoubleSalaryWithPredicate() {
        Double sumSalary = Person.where((Person p) -> p.active).sumDouble((Person p) -> p.salary).getSingleResult();
    ...
    void minAgeWithMultiplePredicates() {
        Integer minAge = Person.where((Person p) -> p.active).where((Person p) -> p.age > 25).min((Person p) -> p.age).getSingleResult();
    ...
    void maxAgeWithMultiplePredicates() {
        Integer maxAge = Person.where((Person p) -> p.active).where((Person p) -> p.salary > 60000.0).max((Person p) -> p.age).getSingleResult();
    ...
    void avgAgeWithMultiplePredicates() {
        Double avgAge = Person.where((Person p) -> p.active).where((Person p) -> p.age >= 30).avg((Person p) -> p.age).getSingleResult();
    ...
    void sumIntegerAgeWithMultiplePredicates() {
        Long sumAge = Person.where((Person p) -> p.active).where((Person p) -> p.age < 35).sumInteger((Person p) -> p.age).getSingleResult();
    ...
    void sumLongEmployeeIdWithMultiplePredicates() {
        Long sumEmployeeId = Person.where((Person p) -> p.active).where((Person p) -> p.employeeId > 1000002L).sumLong((Person p) -> p.employeeId).getSingleResult();
    ...
    void sumDoubleSalaryWithMultiplePredicates() {
        Double sumSalary = Person.where((Person p) -> p.active).where((Person p) -> p.salary >= 65000.0).sumDouble((Person p) -> p.salary).getSingleResult();
    ...
    void minHeight_withNullValues_skipsNulls() {
        ...
        Float minHeight = Person.min((Person p) -> p.height).getSingleResult();
    ...
    void avgSalary_withNullValues_skipsNulls() {
        ...
        Double avgSalary = Person.avg((Person p) -> p.salary).getSingleResult();
    ...
    void minMaxAvg_floatField_height() {
        Float minHeight = Person.min((Person p) -> p.height).getSingleResult();
        Float maxHeight = Person.max((Person p) -> p.height).getSingleResult();
        Double avgHeight = Person.avg((Person p) -> p.height).getSingleResult();
