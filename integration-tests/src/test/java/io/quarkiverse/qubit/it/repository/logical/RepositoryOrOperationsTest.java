...
/**
 * Repository pattern tests for OR logical operations.
 * Mirrors io.quarkiverse.qubit.it.logical.OrOperationsTest using repository injection.
 */
@QuarkusTest
class RepositoryOrOperationsTest {
    ...
    @Test
    void simpleOr() {
        var results = personRepository.where((Person p) -> p.age < 26 || p.age > 40).toList();
