...
public abstract class AbstractArithmeticOperationsTest {
    ...
    void integerAddition() {
        var results = personOps().where((Person p) -> p.age + 5 > 35).toList();
    ...
    void integerSubtraction() {
        var results = personOps().where((Person p) -> p.age - 5 > 20).toList();
    ...
    void integerMultiplication() {
        var results = personOps().where((Person p) -> p.age * 2 > 60).toList();
    ...
    void integerDivision() {
        var results = personOps().where((Person p) -> p.age / 2 > 15).toList();
    ...
    @Test
    void integerModulo() {
        var results = personOps().where((Person p) -> p.age % 10 == 0).toList();
    ...
    @Test
    void longAddition() {
        var results = personOps().where((Person p) -> p.employeeId + 10L > 1000010L).toList();
    ...
    void longSubtraction() {
        var results = personOps().where((Person p) -> p.employeeId - 10L < 1000000L).toList();
    ...
    void longMultiplication() {
        var results = personOps().where((Person p) -> p.employeeId * 2L > 2000000L).toList();
    ...
    @Test
    void longDivision() {
        var results = personOps().where((Person p) -> p.employeeId / 2L < 500002L).toList();
    ...
    @Test
    void longModulo() {
        var results = personOps().where((Person p) -> p.employeeId % 2L == 1L).toList();
    ...
    @Test
    void floatAddition() {
        var results = personOps().where((Person p) -> p.height + 0.10f > 1.85f).toList();
    ...
    void floatSubtraction() {
        var results = personOps().where((Person p) -> p.height - 0.05f < 1.70f).toList();
    ...
    void floatMultiplication() {
        var results = personOps().where((Person p) -> p.height * 2.0f > 3.5f).toList();
    ...
    @Test
    void floatDivision() {
        var results = personOps().where((Person p) -> p.height / 2.0f < 0.85f).toList();
    ...
    @Test
    void doubleAddition() {
        var results = personOps().where((Person p) -> p.salary + 5000.0 > 80000.0).toList();
    ...
    void doubleSubtraction() {
        var results = personOps().where((Person p) -> p.salary - 10000.0 < 70000.0).toList();
    ...
    void doubleMultiplication() {
        var results = personOps().where((Person p) -> p.salary * 1.1 > 80000.0).toList();
    ...
    @Test
    void doubleDivision() {
        var results = personOps().where((Person p) -> p.salary / 1000.0 > 75.0).toList();
    ...
    void floatFieldFieldAddition() {
        var results = personOps().where((Person p) -> p.height + p.height > 3.0f).toList();
    ...
    void floatFieldFieldSubtraction() {
        var results = personOps().where((Person p) -> p.height - p.height == 0.0f).toList();
    ...
    void floatFieldFieldMultiplication() {
        var results = personOps().where((Person p) -> p.height * p.height > 2.0f).toList();
    ...
    void floatFieldFieldDivision() {
        var results = personOps().where((Person p) -> p.height / p.height == 1.0f).toList();
    ...
    void doubleFieldFieldAddition() {
        var results = personOps().where((Person p) -> p.salary + p.salary > 170000.0).toList();
    ...
    void doubleFieldFieldSubtraction() {
        var results = personOps().where((Person p) -> p.salary - p.salary == 0.0).toList();
    ...
    void doubleFieldFieldMultiplication() {
        var results = personOps().where((Person p) -> p.salary * p.salary > 8000000000.0).toList();
    ...
    void doubleFieldFieldDivision() {
        var results = personOps().where((Person p) -> p.salary / p.salary == 1.0).toList();
    ...
    void longWrapperWithIntConstant() {
        var results = personOps().where((Person p) -> p.employeeId + 5 == 1000006L).toList();
    ...
    void doubleWrapperWithIntConstant() {
        var results = personOps().where((Person p) -> p.salary + 1000 == 76000.0).toList();
    ...
    void longWrapperSubtractionWithIntConstant() {
        var results = personOps().where((Person p) -> p.employeeId - 3 == 999999L).toList();
    ...
    void doubleWrapperMultiplicationWithIntConstant() {
        var results = personOps().where((Person p) -> p.salary * 2 == 180000.0).toList();
    ...
    void floatWrapperComparisonWithIntConstant() {
        var results = personOps().where((Person p) -> p.height > 1).toList();
