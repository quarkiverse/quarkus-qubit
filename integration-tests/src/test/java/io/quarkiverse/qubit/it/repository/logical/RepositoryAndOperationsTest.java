 ...
 * Mirrors io.quarkiverse.qubit.it.logical.AndOperationsTest using repository injection.
 */
@QuarkusTest
class RepositoryAndOperationsTest {
    ...
    void twoConditionAnd() {
        var results = personRepository.where((Person p) -> p.age > 25 && p.active).toList();
