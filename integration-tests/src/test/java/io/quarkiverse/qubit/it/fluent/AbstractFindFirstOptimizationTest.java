 ...
 * </ul>
 */
public abstract class AbstractFindFirstOptimizationTest {
    ...
    void findFirst_withLimit5_overridesToLimit1() {
        ...
        Optional<Person> result = personOps().where((Person p) -> p.active)
                .limit(5)
                .findFirst();
    ...
    void findFirst_withSorting_preservesOrder() {
        ...
        Optional<Person> result = personOps().sortedBy((Person p) -> p.firstName)
                .findFirst();
