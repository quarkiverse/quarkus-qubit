...
import io.quarkiverse.qubit.it.logical.AbstractNotOperationsTest;
...
/**
 * Tests for NOT logical operations using repository instance methods.
 */
@QuarkusTest
class RepositoryNotOperationsTest extends AbstractNotOperationsTest {
