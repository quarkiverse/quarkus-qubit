...
public abstract class AbstractProjectionTest {
    ...
    void selectStringField_lastName() {
        List<String> lastNames = personOps().select((Person p) -> p.lastName).toList();
    ...
    void selectStringField_email() {
        List<String> emails = personOps().select((Person p) -> p.email).toList();
    ...
    void selectLongField_employeeId() {
        List<Long> employeeIds = personOps().select((Person p) -> p.employeeId).toList();
    ...
    void selectFloatField_height() {
        List<Float> heights = personOps().select((Person p) -> p.height).toList();
    ...
    void selectLocalDateField_birthDate() {
        List<LocalDate> birthDates = personOps().select((Person p) -> p.birthDate).toList();
