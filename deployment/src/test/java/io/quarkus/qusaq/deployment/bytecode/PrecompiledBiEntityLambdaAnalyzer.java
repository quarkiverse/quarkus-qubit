...
import static io.quarkus.qusaq.runtime.QusaqConstants.BI_QUERY_SPEC_DESCRIPTOR;
import static org.assertj.core.api.Assertions.assertThat;

/**
 * Base class for bi-entity lambda bytecode analysis tests.
 *
 * <p>This analyzer loads the {@link io.quarkus.qusaq.deployment.testutil.BiEntityLambdaTestSources}
...
public abstract class PrecompiledBiEntityLambdaAnalyzer {
    ...
    private static final String SOURCES_CLASS_NAME = "io.quarkus.qusaq.deployment.testutil.BiEntityLambdaTestSources";
