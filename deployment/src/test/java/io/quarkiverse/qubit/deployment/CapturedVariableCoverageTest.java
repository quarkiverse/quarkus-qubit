 ...
 *
 * <p>
 * These tests document and verify that {@code collectCapturedVariableIndices()} does NOT
 ...
 *
 * <p>
 * This is intentional because these expression types are:
 * <ol>
 ...
 *
 * <p>
 * These tests verify that IF these types were ever used in production (which they aren't),
 * any captured variables within them would be silently ignored, resulting in incorrect
 * captured variable counts.
 *
 * <p>
 * <strong>Context:</strong> The {@code containsCapturedVariables()} method was removed
