...
public class Assertions {
    ...
    /**
     * Creates a new instance of <code>{@link io.quarkiverse.qubit.deployment.analysis.QueryExecutionPlanAssert}</code>.
     *
     * @param actual the actual value.
     * @return the created assertion object.
     */
    @org.assertj.core.util.CheckReturnValue
    public static io.quarkiverse.qubit.deployment.analysis.QueryExecutionPlanAssert assertThat(
            io.quarkiverse.qubit.deployment.analysis.QueryExecutionPlan actual) {
        return new io.quarkiverse.qubit.deployment.analysis.QueryExecutionPlanAssert(actual);
    }
    ...
    /**
     * Creates a new instance of <code>{@link io.quarkiverse.qubit.deployment.common.EntityClassInfoAssert}</code>.
     *
     * @param actual the actual value.
     * @return the created assertion object.
     */
    @org.assertj.core.util.CheckReturnValue
    public static io.quarkiverse.qubit.deployment.common.EntityClassInfoAssert assertThat(
            io.quarkiverse.qubit.deployment.common.EntityClassInfo actual) {
        return new io.quarkiverse.qubit.deployment.common.EntityClassInfoAssert(actual);
    }

    /**
     * Creates a new instance of <code>{@link io.quarkiverse.qubit.deployment.metrics.BuildMetricsCollectorAssert}</code>.
     *
     * @param actual the actual value.
     * @return the created assertion object.
     */
    @org.assertj.core.util.CheckReturnValue
    public static io.quarkiverse.qubit.deployment.metrics.BuildMetricsCollectorAssert assertThat(
            io.quarkiverse.qubit.deployment.metrics.BuildMetricsCollector actual) {
        return new io.quarkiverse.qubit.deployment.metrics.BuildMetricsCollectorAssert(actual);
    }
